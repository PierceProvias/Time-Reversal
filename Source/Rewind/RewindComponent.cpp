...
FTransformAndVelocitySnapshot::FTransformAndVelocitySnapshot(float _TimeSinceLastSnapshot, FTransform _Transform, FVector _LinearVelocity, FVector _AngularVelocity)
{
	TimeSinceLastSnapshot = _TimeSinceLastSnapshot;
	Transform = _Transform;
	LinearVelocity = _LinearVelocity;
	AngularVelocityInRadians = _AngularVelocity;
}

FMovementVelocityAndModeSnapshot::FMovementVelocityAndModeSnapshot(float _TimeSinceLastSnapshot, FVector _MovementVelocity, TEnumAsByte<enum EMovementMode> _MovementMode)
{
	TimeSinceLastSnapshot = _TimeSinceLastSnapshot;
